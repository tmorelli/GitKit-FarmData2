...
import { MenuModelRegistry, MessageService, SelectionService } from '@theia/core/lib/common';
...
export declare namespace VSXCommands {
    const TOGGLE_EXTENSIONS: Command;
}
export declare class VSXExtensionsContribution extends AbstractViewContribution<VSXExtensionsViewContainer> implements ColorContribution, FrontendApplicationContribution {
    ...
    protected vsxRegistryService: VSXRegistryService;
     ...
     */
    protected installVsixFile(fileURI: URI): Promise<void>;
    /**
