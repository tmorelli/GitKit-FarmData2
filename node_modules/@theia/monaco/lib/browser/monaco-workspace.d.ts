...
export declare class MonacoWorkspace {
    ...
    readonly onDidOpenTextDocument: import("@theia/core").Event<MonacoEditorModel>;
    protected readonly onDidCloseTextDocumentEmitter: Emitter<MonacoEditorModel>;
    readonly onDidCloseTextDocument: import("@theia/core").Event<MonacoEditorModel>;
    protected readonly onDidChangeTextDocumentEmitter: Emitter<MonacoModelContentChangedEvent>;
    readonly onDidChangeTextDocument: import("@theia/core").Event<MonacoModelContentChangedEvent>;
    protected readonly onDidSaveTextDocumentEmitter: Emitter<MonacoEditorModel>;
    readonly onDidSaveTextDocument: import("@theia/core").Event<MonacoEditorModel>;
