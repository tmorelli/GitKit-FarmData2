 ...
 */
export declare function fileToStream(file: File): ReadableStream<BinaryBuffer>;
/**
 * Convert BinaryBufferReadableStream to Web ReadableStream<Uint8Array>
 */
export declare function binaryStreamToWebStream(binaryStream: ReadableStream<BinaryBuffer>, abortSignal?: AbortSignal): globalThis.ReadableStream<Uint8Array>;
