...
export declare namespace Event {
    ...
    function filter<T>(event: Event<T>, predicate: (e: T) => unknown): Event<T>;
    function filter<T, S extends T>(event: Event<T>, predicate: (e: T) => e is S): Event<S>;
    /**
...
declare class CallbackList implements Iterable<Callback> {
    ...
    private _callbacks;
    private _contexts;
    constructor(errorHandling?: ErrorHandlingStrategy);
    get length(): number;
...
export declare class QueueableEmitter<T> extends Emitter<T[]> {
    currentQueue?: T[];
    queue(...arg: T[]): void;
    fire(): void;
}
