...
export declare class UntitledResourceResolver implements ResourceResolver {
    ...
    createUntitledResource(content?: string, extension?: string, uri?: URI, encoding?: string): Promise<UntitledResource>;
...
export declare class UntitledResource implements Resource {
    ...
    readonly encoding: string | undefined;
    get onDidChangeContents(): Event<void>;
    constructor(resources: Map<string, UntitledResource>, uri: URI, content?: string | undefined, encoding?: string);
    dispose(): void;
    readContents(options?: {
        encoding?: string | undefined;
    } | undefined): Promise<string>;
