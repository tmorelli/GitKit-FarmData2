...
export declare class FileService {
    ...
    private recursiveWatcherIndexes;
    watch(resource: URI, options?: WatchOptions): Disposable;
    doWatch(resource: URI, options: WatchOptions): Promise<Disposable>;
    private createWatcherEntry;
    private createWatcherDisposable;
    private disposeWatcherEntry;
    private promoteSubsumedChildren;
    private findSubsumingParent;
    private isExcludedByParent;
    /**
     ...
     */
    private areExcludesCompatible;
    private matchesExcludePattern;
    private subsumeExistingChildren;
    private getRecursiveWatcherIndex;
    private indexRecursiveWatcher;
    private removeFromRecursiveIndex;
    private isRecursiveWatcherEntry;
    private toWatchKey;
    private writeQueues;
