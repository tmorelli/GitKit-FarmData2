import { Command, CommandContribution, CommandRegistry, MessageService, ILogger } from '@theia/core';
import { ApplicationShell, OpenerService, QuickInputService, TabBar, Widget } from '@theia/core/lib/browser';
