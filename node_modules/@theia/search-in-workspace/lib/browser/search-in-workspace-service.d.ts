...
export declare class SearchInWorkspaceService implements SearchInWorkspaceClient {
    protected pendingSearches: Map<number, SearchInWorkspaceClient>;
    protected pendingOnDones: Map<number, string | undefined>;
    protected lastKnownSearchId: number;
    ...
    protected doSearch(what: string, rootUris: string[], callbacks: SearchInWorkspaceCallbacks, opts?: SearchInWorkspaceOptions): Promise<number>;
