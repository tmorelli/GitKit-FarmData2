...
let OutputToolbarContribution = class OutputToolbarContribution {
    ...
    init() {
        this.widgetManager.onDidCreateWidget(({ factoryId, widget }) => {
            if (factoryId === output_widget_1.OutputWidget.ID && widget instanceof output_widget_1.OutputWidget) {
    ...
    renderChannelSelector() {
        ...
        return (0, jsx_runtime_1.jsx)("div", { id: this.OUTPUT_CHANNEL_LIST_ID, children: (0, jsx_runtime_1.jsx)(select_component_1.SelectComponent, { options: channelOptionElements, defaultValue: this.outputChannelManager.selectedChannel?.name, onChange: option => this.changeChannel(option) }, this.outputChannelManager.selectedChannel?.name) }, this.OUTPUT_CHANNEL_LIST_ID);
    }
};
...
], OutputToolbarContribution.prototype, "widgetManager", void 0);
tslib_1.__decorate([
