...
let SourceTreeWidget = SourceTreeWidget_1 = class SourceTreeWidget extends tree_1.TreeWidget {
    ...
    renderTree(model) {
        if (source_tree_1.TreeSourceNode.is(model.root) && model.root.children.length === 0) {
            ...
            if (placeholder) {
                return (0, jsx_runtime_1.jsx)("div", { className: 'theia-tree-source-node-placeholder noselect', children: placeholder });
            }
        }
    ...
    renderCaption(node) {
        if (source_tree_1.TreeElementNode.is(node)) {
            ...
            return (0, jsx_runtime_1.jsx)("div", { className: classNames.join(' '), children: node.element.render(this) });
        }
        return undefined;
    }
