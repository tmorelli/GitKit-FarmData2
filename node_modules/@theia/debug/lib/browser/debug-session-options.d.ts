...
export type DynamicDebugConfigurationSessionOptions = DebugConfigurationSessionOptions & {
    providerType: string;
};
...
export declare namespace DebugSessionOptions {
    function is(options: unknown): options is DebugSessionOptions;
...
export type InternalDebugSessionOptions = DebugSessionOptions & {
    id: number;
};
