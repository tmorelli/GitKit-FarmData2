...
import { AbstractViewContribution, HoverService, Widget } from '@theia/core/lib/browser';
...
import { Disposable, DisposableCollection, Emitter, InMemoryResources } from '@theia/core';
...
export declare class DebugConsoleContribution extends AbstractViewContribution<ConsoleWidget> implements TabBarToolbarContribution, Disposable {
    ...
    protected readonly filterChangedEmitter: Emitter<void>;
    ...
    protected applyFilterDebounced: import("lodash").DebouncedFunc<(value: string) => void>;
