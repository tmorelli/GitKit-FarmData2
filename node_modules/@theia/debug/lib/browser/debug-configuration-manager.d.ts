...
export declare class DebugConfigurationManager {
    ...
    protected readonly onDidChangeDynamicConfigurationsEmitter: Emitter<void>;
    /**
     * Fires when the set of dynamic debug configuration providers changes
     * (i.e., when providers are registered or unregistered).
     */
    readonly onDidChangeDynamicConfigurations: Event<void>;
     ...
     */
    provideDynamicDebugConfigurationsByType(providerType: string): Promise<DynamicDebugConfigurationSessionOptions[]>;
    protected fireWillProvideDynamicDebugConfiguration(debugType?: string): Promise<void>;
