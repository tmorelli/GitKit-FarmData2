...
export declare class DebugEditorModel implements Disposable {
    ...
    protected breakpointRanges: Map<string, [monaco.Range, DebugSourceBreakpoint]>;
     ...
     */
    protected ignoreDecorationsChangedEvent: boolean;
    /**
     * Set during `updateBreakpoints()` to prevent the resulting
     * `onDidChangeBreakpoints` from re-entering `render()`.
     */
    protected ignoreBreakpointsChangeEvent: boolean;
    protected toDisposeOnModelChange: DisposableCollection;
