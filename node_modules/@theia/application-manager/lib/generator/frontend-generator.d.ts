...
export declare class FrontendGenerator extends AbstractGenerator {
    ...
    protected compileIndexHtml(frontendModules: Map<string, string>): Promise<string>;
    protected compileIndexHead(frontendModules: Map<string, string>): Promise<string>;
