...
import { OpenerService, KeybindingRegistry, KeybindingContribution, FrontendApplicationContribution, OnWillStopAction, Navigatable, SaveableSource, Widget, QuickInputService } from '@theia/core/lib/browser';
...
export declare class WorkspaceFrontendContribution implements CommandContribution, KeybindingContribution, MenuContribution, FrontendApplicationContribution {
    ...
    protected manageWorkspaceTrust(): Promise<void>;
