import { MenuModelRegistry, CommandRegistry, PreferenceScope, PreferenceService } from '@theia/core';
import { AbstractViewContribution, KeybindingRegistry, Widget, QuickInputService } from '@theia/core/lib/browser';
