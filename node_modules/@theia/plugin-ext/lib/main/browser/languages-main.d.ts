...
import { DocumentDropEditProvider, DocumentDropEditsSession, EvaluatableExpression, EvaluatableExpressionProvider, InlineValue, InlineValueContext, InlineValuesProvider, MultiDocumentHighlightProvider } from '@theia/monaco-editor-core/esm/vs/editor/common/languages';
...
export declare class LanguagesMainImpl implements LanguagesMain, Disposable {
    ...
    protected provideMultiDocumentHighlights(handle: number, model: monaco.editor.ITextModel, position: monaco.Position, otherModels: monaco.editor.ITextModel[], token: monaco.CancellationToken): monaco.languages.ProviderResult<Map<monaco.Uri, monaco.languages.DocumentHighlight[]>>;
