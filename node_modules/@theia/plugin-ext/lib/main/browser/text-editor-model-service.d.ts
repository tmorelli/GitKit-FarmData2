import { Event, Listener, ILogger } from '@theia/core';
...
export declare class EditorModelService {
    ...
    private modelEncodingEmitter;
    private modelSavedEmitter;
    private onModelWillSaveListeners;
    readonly onModelDirtyChanged: Event<MonacoEditorModel>;
    readonly onModelEncodingChanged: Event<{
        model: MonacoEditorModel;
        encoding: string;
    }>;
    readonly onModelWillSave: Listener.Registration<WillSaveMonacoModelEvent, Promise<void>>;
