...
import { ApplicationShell, OpenHandler, OpenerOptions, Widget, WidgetManager, WidgetOpenerOptions } from '@theia/core/lib/browser';
...
export declare class CustomEditorOpener implements OpenHandler {
    ...
    constructor(editor: CustomEditor, shell: ApplicationShell, widgetManager: WidgetManager, editorRegistry: PluginCustomEditorRegistry, preferenceService: PreferenceService);
    ...
    protected openCustomEditor(uri: URI, options?: EditorOpenerOptions): Promise<CustomEditorWidget>;
    protected isPreviewEnabled(options?: EditorOpenerOptions): boolean;
    protected openSideBySide(uri: URI, options?: WidgetOpenerOptions): Promise<Widget | undefined>;
