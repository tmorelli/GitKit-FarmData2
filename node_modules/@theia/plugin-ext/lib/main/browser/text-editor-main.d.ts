...
import { TextEditorConfiguration, EditorChangedPropertiesData, Selection, TextEditorConfigurationUpdate, TextEditorRevealType, SingleEditOperation, ApplyEditsOptions, SnippetEditOptions, DecorationOptions } from '../../common/plugin-api-rpc';
...
export declare class TextEditorMain implements Disposable {
    ...
    constructor(id: string, model: monaco.editor.IModel | ITextModel, editor: MonacoEditor | SimpleMonacoEditor);
    dispose(): void;
...
export declare class TextEditorPropertiesMain {
    ...
    static readFromEditor(prevProperties: TextEditorPropertiesMain | undefined, model: monaco.editor.IModel | ITextModel, editor: MonacoEditor | SimpleMonacoEditor): TextEditorPropertiesMain;
