...
const lm_tool_main_1 = require("./lm-tool-main");
function setUpPluginApi(rpc, container) {
    ...
    rpc.set(plugin_api_rpc_1.PLUGIN_RPC_CONTEXT.FILE_SYSTEM_EVENT_SERVICE_MAIN, fsEventService);
    ...
    const languageModelToolsMain = new lm_tool_main_1.LanguageModelToolsMainImpl(rpc, container);
    rpc.set(plugin_api_rpc_1.PLUGIN_RPC_CONTEXT.LM_TOOLS_MAIN, languageModelToolsMain);
}
