...
import { Plugin, ScmExt, ScmMain, ScmHistoryItemRefDto, ScmHistoryItemDto, ScmHistoryItemChangeDto, ScmHistoryOptionsDto } from '../common';
...
export declare class ScmExtImpl implements ScmExt {
    ...
    createSourceControl(extension: Plugin, id: string, label: string, rootUri: theia.Uri | undefined, iconPath?: theia.IconPath, isHidden?: boolean, parent?: theia.SourceControl): theia.SourceControl;
    ...
    $provideHistoryItems(sourceControlHandle: number, options: ScmHistoryOptionsDto, token: CancellationToken): Promise<ScmHistoryItemDto[] | undefined>;
