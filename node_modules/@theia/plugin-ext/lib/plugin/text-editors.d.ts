import { TextEditorsExt, EditorChangedPropertiesData, TextEditorPositionData, TextEditorsMain, TextEditorDiffInformationDto } from '../common/plugin-api-rpc';
...
export declare class TextEditorsExtImpl implements TextEditorsExt {
    ...
    readonly onDidChangeTextEditorDiffInformation: Event<theia.TextEditorDiffInformationChangeEvent>;
