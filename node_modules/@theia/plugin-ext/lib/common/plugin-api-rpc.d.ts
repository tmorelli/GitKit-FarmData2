...
export declare namespace ScmHistoryItemCommandArg {
    function is(arg: unknown): arg is ScmHistoryItemCommandArg;
}
...
export interface LanguagesExt {
    ...
    $provideMultiDocumentHighlights(handle: number, resource: UriComponents, position: Position, otherResources: UriComponents[], token: CancellationToken): Promise<MultiDocumentHighlightDto[] | undefined>;
...
export declare const PLUGIN_RPC_CONTEXT: {
    ...
    FILE_SYSTEM_EVENT_SERVICE_MAIN: import("./rpc-protocol").ProxyIdentifier<MainFileSystemEventServiceShape>;
    ...
    LM_TOOLS_MAIN: import("./rpc-protocol").ProxyIdentifier<LanguageModelToolsMain>;
};
export declare const MAIN_RPC_CONTEXT: {
    ...
    LM_TOOLS_EXT: import("./rpc-protocol").ProxyIdentifier<LanguageModelToolsExt>;
};
