...
export declare class EncodedTokenizationResult {
     ...
     *
     */
    tokens: Uint32Array, fontInfo: IFontToken[], endState: IState);
}
...
export declare class VersionedExtensionId {
    ...
    static tryCreate(extensionId: string | undefined, version: string | undefined): VersionedExtensionId | undefined;
