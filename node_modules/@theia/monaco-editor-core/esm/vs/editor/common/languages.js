...
(function (CompletionItemKinds) {
    ...
    function toLabel(kind) {
        switch (kind) {
            case 0 /* CompletionItemKind.Method */: return localize(809, 'Method');
            case 1 /* CompletionItemKind.Function */: return localize(810, 'Function');
            case 2 /* CompletionItemKind.Constructor */: return localize(811, 'Constructor');
            case 3 /* CompletionItemKind.Field */: return localize(812, 'Field');
            case 4 /* CompletionItemKind.Variable */: return localize(813, 'Variable');
            case 5 /* CompletionItemKind.Class */: return localize(814, 'Class');
            case 6 /* CompletionItemKind.Struct */: return localize(815, 'Struct');
            case 7 /* CompletionItemKind.Interface */: return localize(816, 'Interface');
            case 8 /* CompletionItemKind.Module */: return localize(817, 'Module');
            case 9 /* CompletionItemKind.Property */: return localize(818, 'Property');
            case 10 /* CompletionItemKind.Event */: return localize(819, 'Event');
            case 11 /* CompletionItemKind.Operator */: return localize(820, 'Operator');
            case 12 /* CompletionItemKind.Unit */: return localize(821, 'Unit');
            case 13 /* CompletionItemKind.Value */: return localize(822, 'Value');
            case 14 /* CompletionItemKind.Constant */: return localize(823, 'Constant');
            case 15 /* CompletionItemKind.Enum */: return localize(824, 'Enum');
            case 16 /* CompletionItemKind.EnumMember */: return localize(825, 'Enum Member');
            case 17 /* CompletionItemKind.Keyword */: return localize(826, 'Keyword');
            case 18 /* CompletionItemKind.Text */: return localize(827, 'Text');
            case 19 /* CompletionItemKind.Color */: return localize(828, 'Color');
            case 20 /* CompletionItemKind.File */: return localize(829, 'File');
            case 21 /* CompletionItemKind.Reference */: return localize(830, 'Reference');
            case 22 /* CompletionItemKind.Customcolor */: return localize(831, 'Custom Color');
            case 23 /* CompletionItemKind.Folder */: return localize(832, 'Folder');
            case 24 /* CompletionItemKind.TypeParameter */: return localize(833, 'Type Parameter');
            case 25 /* CompletionItemKind.User */: return localize(834, 'User');
            case 26 /* CompletionItemKind.Issue */: return localize(835, 'Issue');
            case 27 /* CompletionItemKind.Tool */: return localize(836, 'Tool');
            case 28 /* CompletionItemKind.Snippet */: return localize(837, 'Snippet');
            default: return '';
        }
    }
...
export const symbolKindNames = {
    [17 /* SymbolKind.Array */]: localize(838, "array"),
    [16 /* SymbolKind.Boolean */]: localize(839, "boolean"),
    [4 /* SymbolKind.Class */]: localize(840, "class"),
    [13 /* SymbolKind.Constant */]: localize(841, "constant"),
    [8 /* SymbolKind.Constructor */]: localize(842, "constructor"),
    [9 /* SymbolKind.Enum */]: localize(843, "enumeration"),
    [21 /* SymbolKind.EnumMember */]: localize(844, "enumeration member"),
    [23 /* SymbolKind.Event */]: localize(845, "event"),
    [7 /* SymbolKind.Field */]: localize(846, "field"),
    [0 /* SymbolKind.File */]: localize(847, "file"),
    [11 /* SymbolKind.Function */]: localize(848, "function"),
    [10 /* SymbolKind.Interface */]: localize(849, "interface"),
    [19 /* SymbolKind.Key */]: localize(850, "key"),
    [5 /* SymbolKind.Method */]: localize(851, "method"),
    [1 /* SymbolKind.Module */]: localize(852, "module"),
    [2 /* SymbolKind.Namespace */]: localize(853, "namespace"),
    [20 /* SymbolKind.Null */]: localize(854, "null"),
    [15 /* SymbolKind.Number */]: localize(855, "number"),
    [18 /* SymbolKind.Object */]: localize(856, "object"),
    [24 /* SymbolKind.Operator */]: localize(857, "operator"),
    [3 /* SymbolKind.Package */]: localize(858, "package"),
    [6 /* SymbolKind.Property */]: localize(859, "property"),
    [14 /* SymbolKind.String */]: localize(860, "string"),
    [22 /* SymbolKind.Struct */]: localize(861, "struct"),
    [25 /* SymbolKind.TypeParameter */]: localize(862, "type parameter"),
    [12 /* SymbolKind.Variable */]: localize(863, "variable"),
};
/**
 * @internal
 */
export function getAriaLabelForSymbol(symbolName, kind) {
    return localize(864, '{0} ({1})', symbolName, symbolKindNames[kind]);
}
/**
 * @internal
 */
