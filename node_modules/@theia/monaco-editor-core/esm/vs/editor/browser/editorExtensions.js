...
export const UndoCommand = registerCommand(new MultiCommand({
    ...
    menuOpts: [{
            ...
            group: '1_do',
            title: nls.localize(144, "&&Undo"),
            order: 1
        }, {
            menuId: MenuId.CommandPalette,
            group: '',
            title: nls.localize(145, "Undo"),
            order: 1
        }, {
            menuId: MenuId.SimpleEditorContext,
            group: '1_do',
            title: nls.localize(146, "Undo"),
            order: 1
        }]
}));
...
export const RedoCommand = registerCommand(new MultiCommand({
    ...
    menuOpts: [{
            menuId: MenuId.MenubarEditMenu,
            group: '1_do',
            title: nls.localize(147, "&&Redo"),
            order: 2
        }, {
            menuId: MenuId.CommandPalette,
            group: '',
            title: nls.localize(148, "Redo"),
            order: 1
        }, {
            menuId: MenuId.SimpleEditorContext,
            group: '1_do',
            title: nls.localize(149, "Redo"),
            order: 2
        }]
}));
...
export const SelectAllCommand = registerCommand(new MultiCommand({
    ...
    menuOpts: [{
            ...
            group: '1_basic',
            title: nls.localize(150, "&&Select All"),
            order: 1
        }, {
            menuId: MenuId.CommandPalette,
            group: '',
            title: nls.localize(151, "Select All"),
            order: 1
        }, {
            menuId: MenuId.SimpleEditorContext,
            group: '9_select',
            title: nls.localize(152, "Select All"),
            order: 1
        }]
}));
