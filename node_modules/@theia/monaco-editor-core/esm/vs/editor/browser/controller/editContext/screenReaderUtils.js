...
export function ariaLabelForScreenReaderContent(options, keybindingService) {
    ...
    if (accessibilitySupport === 1 /* AccessibilitySupport.Disabled */) {
        ...
        const editorNotAccessibleMessage = nls.localize(136, "The editor is not accessible at this time.");
        if (toggleKeybindingLabel) {
            return nls.localize(137, "{0} To enable screen reader optimized mode, use {1}", editorNotAccessibleMessage, toggleKeybindingLabel);
        }
        else if (runCommandKeybindingLabel) {
            return nls.localize(138, "{0} To enable screen reader optimized mode, open the quick pick with {1} and run the command Toggle Screen Reader Accessibility Mode, which is currently not triggerable via keyboard.", editorNotAccessibleMessage, runCommandKeybindingLabel);
        }
        else if (keybindingEditorKeybindingLabel) {
            return nls.localize(139, "{0} Please assign a keybinding for the command Toggle Screen Reader Accessibility Mode by accessing the keybindings editor with {1} and run it.", editorNotAccessibleMessage, keybindingEditorKeybindingLabel);
        }
        else {
            // SOS
