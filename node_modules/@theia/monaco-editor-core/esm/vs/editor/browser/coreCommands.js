...
(function (CoreNavigationCommands) {
        ...
        metadata: {
            ...
            args: [{
                    ...
                    schema: {
                        ...
                        properties: {
                            'sticky': {
                                description: nls.localize(141, "Stick to the end even when going to longer lines"),
                                type: 'boolean',
                                default: false
                            }
                        }
        ...
        metadata: {
            ...
            args: [{
                    ...
                    schema: {
                        ...
                        properties: {
                            'sticky': {
                                description: nls.localize(142, "Stick to the end even when going to longer lines"),
                                type: 'boolean',
                                default: false
                            }
                        }
    ...
    CoreNavigationCommands.RemoveSecondaryCursors = registerEditorCommand(new class extends CoreEditorCommand {
        ...
        runCoreEditorCommand(viewModel, args) {
            ...
            viewModel.revealAllCursors(args.source, true);
            status(nls.localize(143, "Removed secondary cursors"));
        }
    });
