...
const InlineCompletionsSnoozing = new RawContextKey('inlineCompletions.snoozed', false, localize(154, "Whether inline completions are currently snoozed"));
...
export class SnoozeInlineCompletion extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(156, "Snooze Inline Suggestions"),
    ...
    async getDurationFromUser(quickInputService, storageService) {
        ...
        const picked = await quickInputService.pick(items, {
            placeHolder: localize(155, "Select snooze duration for Inline Suggestions"),
...
export class CancelSnoozeInlineCompletion extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(157, "Cancel Snooze Inline Suggestions"),
