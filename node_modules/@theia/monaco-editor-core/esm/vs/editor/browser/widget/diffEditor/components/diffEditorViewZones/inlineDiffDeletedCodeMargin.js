                ...
                getActions: () => {
                    ...
                    actions.push(new Action('diff.clipboard.copyDeletedContent', isDeletion
                        ? (_diff.original.length > 1
                            ? localize(187, "Copy deleted lines")
                            : localize(188, "Copy deleted line"))
                        : (_diff.original.length > 1
                            ? localize(189, "Copy changed lines")
                            : localize(190, "Copy changed line")), undefined, true, async () => {
                    ...
                    if (_diff.original.length > 1) {
                        actions.push(new Action('diff.clipboard.copyDeletedLineContent', isDeletion
                            ? localize(191, "Copy deleted line ({0})", _diff.original.startLineNumber + currentLineNumberOffset)
                            : localize(192, "Copy changed line ({0})", _diff.original.startLineNumber + currentLineNumberOffset), undefined, true, async () => {
                    ...
                    if (!readOnly) {
                        actions.push(new Action('diff.inline.revertChange', localize(193, "Revert this change"), undefined, true, async () => {
