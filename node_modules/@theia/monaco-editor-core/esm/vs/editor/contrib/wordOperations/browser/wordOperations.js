...
export class DeleteInsideWord extends EditorAction {
    constructor() {
        super({
            id: 'deleteInsideWord',
            precondition: EditorContextKeys.writable,
            label: nls.localize2(1710, "Delete Word"),
            metadata: {
                description: nls.localize2(1711, "Delete the word at the cursor"),
                args: [{
                        name: 'args',
                        schema: {
                            type: 'object',
                            properties: {
                                'onlyWord': {
                                    type: 'boolean',
                                    default: false,
                                    description: nls.localize(1709, "Delete only the word and leave surrounding whitespace")
                                }
                            }
                        }
                    }]
