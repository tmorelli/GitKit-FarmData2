...
export class ToggleStickyScroll extends EditorAction2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(1580, "Toggle Editor Sticky Scroll"),
                mnemonicTitle: localize(1576, "&&Toggle Editor Sticky Scroll"),
            },
            metadata: {
                description: localize2(1581, "Toggle/enable the editor sticky scroll which shows the nested scopes at the top of the viewport"),
            },
            category: Categories.View,
            toggled: {
                condition: ContextKeyExpr.equals('config.editor.stickyScroll.enabled', true),
                title: localize(1577, "Sticky Scroll"),
                mnemonicTitle: localize(1578, "&&Sticky Scroll"),
            },
            menu: [
...
export class FocusStickyScroll extends EditorAction2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(1582, "Focus Editor Sticky Scroll"),
                mnemonicTitle: localize(1579, "&&Focus Editor Sticky Scroll"),
            },
...
export class SelectNextStickyScrollLine extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(1583, "Select the next editor sticky scroll line"),
...
export class SelectPreviousStickyScrollLine extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(1584, "Select the previous sticky scroll line"),
            precondition: EditorContextKeys.stickyScrollFocused.isEqualTo(true),
            keybinding: {
                weight,
...
export class GoToStickyScrollLine extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(1585, "Go to the focused sticky scroll line"),
            precondition: EditorContextKeys.stickyScrollFocused.isEqualTo(true),
            keybinding: {
                weight,
...
export class SelectEditor extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(1586, "Select Editor"),
            precondition: EditorContextKeys.stickyScrollFocused.isEqualTo(true),
            keybinding: {
                weight,
