...
let ContextMenuController = class ContextMenuController {
    ...
    _showScrollbarContextMenu(anchor) {
        ...
        const actions = [];
        actions.push(createAction({
            label: nls.localize(1021, "Minimap"),
        ...
        actions.push(createAction({
            label: nls.localize(1022, "Render Characters"),
        ...
        actions.push(createEnumAction(nls.localize(1023, "Vertical size"), minimapOptions.enabled, 'editor.minimap.size', minimapOptions.size, [{
                label: nls.localize(1024, "Proportional"),
                value: 'proportional'
            }, {
                label: nls.localize(1025, "Fill"),
                value: 'fill'
            }, {
                label: nls.localize(1026, "Fit"),
                value: 'fit'
            }]));
        actions.push(createEnumAction(nls.localize(1027, "Slider"), minimapOptions.enabled, 'editor.minimap.showSlider', minimapOptions.showSlider, [{
                label: nls.localize(1028, "Mouse Over"),
                value: 'mouseover'
            }, {
                label: nls.localize(1029, "Always"),
                value: 'always'
            }]));
        const useShadowDOM = this._editor.getOption(144 /* EditorOption.useShadowDOM */) && !isIOS; // Do not use shadow dom on IOS #122035
        this._contextMenuIsBeingShownCount++;
...
class ShowContextMenu extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1030, "Show Editor Context Menu"),
