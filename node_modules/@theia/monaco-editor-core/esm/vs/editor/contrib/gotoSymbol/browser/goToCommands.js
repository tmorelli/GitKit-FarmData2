...
export class DefinitionAction extends SymbolNavigationAction {
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return new ReferencesModel(await getDefinitionsAtPosition(languageFeaturesService.definitionProvider, model, position, false, token), nls.localize(1159, 'Definitions'));
    }
    _getNoResultFoundMessage(info) {
        return info && info.word
            ? nls.localize(1160, "No definition found for '{0}'", info.word)
            : nls.localize(1161, "No definition found");
    }
...
registerAction2(class GoToDefinitionAction extends DefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...nls.localize2(1185, "Go to Definition"),
                mnemonicTitle: nls.localize(1162, "Go to &&Definition"),
            },
...
registerAction2(class OpenDefinitionToSideAction extends DefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: nls.localize2(1186, "Open Definition to the Side"),
...
registerAction2(class PeekDefinitionAction extends DefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: nls.localize2(1187, "Peek Definition"),
...
class DeclarationAction extends SymbolNavigationAction {
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return new ReferencesModel(await getDeclarationsAtPosition(languageFeaturesService.declarationProvider, model, position, false, token), nls.localize(1163, 'Declarations'));
    }
    _getNoResultFoundMessage(info) {
        return info && info.word
            ? nls.localize(1164, "No declaration found for '{0}'", info.word)
            : nls.localize(1165, "No declaration found");
    }
    _getAlternativeCommand(editor) {
...
registerAction2(class GoToDeclarationAction extends DeclarationAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...nls.localize2(1188, "Go to Declaration"),
                mnemonicTitle: nls.localize(1166, "Go to &&Declaration"),
            },
    ...
    _getNoResultFoundMessage(info) {
        return info && info.word
            ? nls.localize(1167, "No declaration found for '{0}'", info.word)
            : nls.localize(1168, "No declaration found");
    }
});
registerAction2(class PeekDeclarationAction extends DeclarationAction {
    constructor() {
        super({
            ...
            title: nls.localize2(1189, "Peek Declaration"),
...
class TypeDefinitionAction extends SymbolNavigationAction {
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return new ReferencesModel(await getTypeDefinitionsAtPosition(languageFeaturesService.typeDefinitionProvider, model, position, false, token), nls.localize(1169, 'Type Definitions'));
    }
    _getNoResultFoundMessage(info) {
        return info && info.word
            ? nls.localize(1170, "No type definition found for '{0}'", info.word)
            : nls.localize(1171, "No type definition found");
    }
    _getAlternativeCommand(editor) {
...
registerAction2(class GoToTypeDefinitionAction extends TypeDefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...nls.localize2(1190, "Go to Type Definition"),
                mnemonicTitle: nls.localize(1172, "Go to &&Type Definition"),
            },
...
registerAction2(class PeekTypeDefinitionAction extends TypeDefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: nls.localize2(1191, "Peek Type Definition"),
...
class ImplementationAction extends SymbolNavigationAction {
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return new ReferencesModel(await getImplementationsAtPosition(languageFeaturesService.implementationProvider, model, position, false, token), nls.localize(1173, 'Implementations'));
    }
    _getNoResultFoundMessage(info) {
        return info && info.word
            ? nls.localize(1174, "No implementation found for '{0}'", info.word)
            : nls.localize(1175, "No implementation found");
    }
    _getAlternativeCommand(editor) {
...
registerAction2(class GoToImplementationAction extends ImplementationAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...nls.localize2(1192, "Go to Implementations"),
                mnemonicTitle: nls.localize(1176, "Go to &&Implementations"),
            },
...
registerAction2(class PeekImplementationAction extends ImplementationAction {
    ...
    constructor() {
        super({
            ...
            title: nls.localize2(1193, "Peek Implementations"),
...
class ReferencesAction extends SymbolNavigationAction {
    _getNoResultFoundMessage(info) {
        return info
            ? nls.localize(1177, "No references found for '{0}'", info.word)
            : nls.localize(1178, "No references found");
    }
    _getAlternativeCommand(editor) {
...
registerAction2(class GoToReferencesAction extends ReferencesAction {
    constructor() {
        super({
            ...
            title: {
                ...nls.localize2(1194, "Go to References"),
                mnemonicTitle: nls.localize(1179, "Go to &&References"),
            },
    ...
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return new ReferencesModel(await getReferencesAtPosition(languageFeaturesService.referenceProvider, model, position, true, false, token), nls.localize(1180, 'References'));
    }
});
registerAction2(class PeekReferencesAction extends ReferencesAction {
    constructor() {
        super({
            ...
            title: nls.localize2(1195, "Peek References"),
            precondition: ContextKeyExpr.and(EditorContextKeys.hasReferenceProvider, PeekContext.notInPeekEditor, EditorContextKeys.isInEmbeddedEditor.toNegated()),
            menu: {
                id: MenuId.EditorContextPeek,
                group: 'peek',
    ...
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return new ReferencesModel(await getReferencesAtPosition(languageFeaturesService.referenceProvider, model, position, false, false, token), nls.localize(1181, 'References'));
    }
});
//#endregion
...
class GenericGoToLocationAction extends SymbolNavigationAction {
    constructor(config, _references, _gotoMultipleBehaviour) {
        super(config, {
            ...
            title: nls.localize2(1196, "Go to Any Symbol"),
    ...
    async _getLocationModel(languageFeaturesService, _model, _position, _token) {
        return new ReferencesModel(this._references, nls.localize(1182, 'Locations'));
    }
    _getNoResultFoundMessage(info) {
        return info && nls.localize(1183, "No results for '{0}'", info.word) || '';
    }
    _getGoToPreference(editor) {
...
CommandsRegistry.registerCommand({
    ...
    handler: (accessor, resource, position) => {
        ...
        return codeEditorService.openCodeEditor({ resource }, codeEditorService.getFocusedCodeEditor()).then(control => {
            ...
            const references = createCancelablePromise(token => getReferencesAtPosition(languageFeaturesService.referenceProvider, control.getModel(), corePosition.Position.lift(position), false, false, token).then(references => new ReferencesModel(references, nls.localize(1184, 'References'))));
