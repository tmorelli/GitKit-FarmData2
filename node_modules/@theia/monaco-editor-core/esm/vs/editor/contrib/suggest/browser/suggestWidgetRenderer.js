...
const suggestMoreInfoIcon = registerIcon('suggest-more-info', Codicon.chevronRight, nls.localize(1626, 'Icon for more information in the suggest widget.'));
...
let ItemRenderer = class ItemRenderer {
    ...
    renderTemplate(container) {
        ...
        readMore.title = nls.localize(1627, "Read More");
        const configureFont = () => {
