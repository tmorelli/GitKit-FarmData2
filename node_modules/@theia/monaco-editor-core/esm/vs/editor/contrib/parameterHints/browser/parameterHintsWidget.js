...
const $ = dom.$;
const parameterHintsNextIcon = registerIcon('parameter-hints-next', Codicon.chevronDown, nls.localize(1444, 'Icon for show next parameter hint.'));
const parameterHintsPreviousIcon = registerIcon('parameter-hints-previous', Codicon.chevronUp, nls.localize(1445, 'Icon for show previous parameter hint.'));
    ...
    render(hints) {
        ...
        if (activeParameter) {
            ...
            if (this.announcedLabel !== labelToAnnounce) {
                aria.alert(nls.localize(1446, "{0}, hint", labelToAnnounce));
...
registerColor('editorHoverWidget.highlightForeground', listHighlightForeground, nls.localize(1447, 'Foreground color of the active item in the parameter hint.'));
