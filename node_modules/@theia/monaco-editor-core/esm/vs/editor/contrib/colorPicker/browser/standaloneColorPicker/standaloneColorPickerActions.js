...
export class ShowOrFocusStandaloneColorPicker extends EditorAction2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(1009, "Show or Focus Standalone Color Picker"),
                mnemonicTitle: localize(1008, "&&Show or Focus Standalone Color Picker"),
            },
            ...
            metadata: {
                description: localize2(1010, "Show or focus a standalone color picker which uses the default color provider. It displays hex/rgb/hsl colors."),
            }
        });
    }
...
export class HideStandaloneColorPicker extends EditorAction {
    constructor() {
        super({
            ...
            label: localize2(1011, "Hide the Color Picker"),
            ...
            metadata: {
                description: localize2(1012, "Hide the standalone color picker."),
            }
        });
    }
...
export class InsertColorWithStandaloneColorPicker extends EditorAction {
    constructor() {
        super({
            ...
            label: localize2(1013, "Insert Color with Standalone Color Picker"),
            ...
            metadata: {
                description: localize2(1014, "Insert hex/rgb/hsl colors with the focused standalone color picker."),
            }
        });
    }
    run(_accessor, editor) {
