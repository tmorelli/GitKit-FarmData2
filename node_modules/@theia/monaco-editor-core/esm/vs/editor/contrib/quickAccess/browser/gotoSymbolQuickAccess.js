...
let AbstractGotoSymbolQuickAccessProvider = class AbstractGotoSymbolQuickAccessProvider extends AbstractEditorNavigationQuickAccessProvider {
    ...
    provideWithoutTextEditor(picker) {
        this.provideLabelPick(picker, localize(1477, "To go to a symbol, first open a text editor with symbol information."));
    ...
    doProvideWithoutEditorSymbols(context, model, picker, token) {
        ...
        this.provideLabelPick(picker, localize(1478, "The active text editor does not provide symbol information."));
            ...
            try {
                ...
                if (items.length > 0) {
                    ...
                    if (query.original.length > 0) {
                        this.provideLabelPick(picker, localize(1479, "No matching editor symbols"));
                    }
                    else {
                        this.provideLabelPick(picker, localize(1480, "No editor symbols"));
                    }
                }
            }
            finally {
    ...
    async doGetSymbolPicks(symbolsPromise, query, options, token, model) {
        ...
        if (openSideBySideDirection) {
            buttons = [{
                    ...
                    tooltip: openSideBySideDirection === 'right' ? localize(1481, "Open to the Side") : localize(1482, "Open to the Bottom")
                }];
        }
        ...
        if (filterBySymbolKind) {
            ...
            symbolPicks = [
                { label: localize(1483, "symbols ({0})", filteredSymbolPicks.length), type: 'separator' },
...
// #region NLS Helpers
const FALLBACK_NLS_SYMBOL_KIND = localize(1484, "properties ({0})");
const NLS_SYMBOL_KIND_CACHE = {
    [5 /* SymbolKind.Method */]: localize(1485, "methods ({0})"),
    [11 /* SymbolKind.Function */]: localize(1486, "functions ({0})"),
    [8 /* SymbolKind.Constructor */]: localize(1487, "constructors ({0})"),
    [12 /* SymbolKind.Variable */]: localize(1488, "variables ({0})"),
    [4 /* SymbolKind.Class */]: localize(1489, "classes ({0})"),
    [22 /* SymbolKind.Struct */]: localize(1490, "structs ({0})"),
    [23 /* SymbolKind.Event */]: localize(1491, "events ({0})"),
    [24 /* SymbolKind.Operator */]: localize(1492, "operators ({0})"),
    [10 /* SymbolKind.Interface */]: localize(1493, "interfaces ({0})"),
    [2 /* SymbolKind.Namespace */]: localize(1494, "namespaces ({0})"),
    [3 /* SymbolKind.Package */]: localize(1495, "packages ({0})"),
    [25 /* SymbolKind.TypeParameter */]: localize(1496, "type parameters ({0})"),
    [1 /* SymbolKind.Module */]: localize(1497, "modules ({0})"),
    [6 /* SymbolKind.Property */]: localize(1498, "properties ({0})"),
    [9 /* SymbolKind.Enum */]: localize(1499, "enumerations ({0})"),
    [21 /* SymbolKind.EnumMember */]: localize(1500, "enumeration members ({0})"),
    [14 /* SymbolKind.String */]: localize(1501, "strings ({0})"),
    [0 /* SymbolKind.File */]: localize(1502, "files ({0})"),
    [17 /* SymbolKind.Array */]: localize(1503, "arrays ({0})"),
    [15 /* SymbolKind.Number */]: localize(1504, "numbers ({0})"),
    [16 /* SymbolKind.Boolean */]: localize(1505, "booleans ({0})"),
    [18 /* SymbolKind.Object */]: localize(1506, "objects ({0})"),
    [19 /* SymbolKind.Key */]: localize(1507, "keys ({0})"),
    [7 /* SymbolKind.Field */]: localize(1508, "fields ({0})"),
    [13 /* SymbolKind.Constant */]: localize(1509, "constants ({0})")
};
//#endregion
