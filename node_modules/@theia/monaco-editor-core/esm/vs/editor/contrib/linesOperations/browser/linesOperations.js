...
class CopyLinesUpAction extends AbstractCopyLinesAction {
    constructor() {
        super(false, {
            ...
            label: nls.localize2(1381, "Copy Line Up"),
            ...
            menuOpts: {
                ...
                group: '2_line',
                title: nls.localize(1376, "&&Copy Line Up"),
                order: 1
            },
...
class CopyLinesDownAction extends AbstractCopyLinesAction {
    constructor() {
        super(true, {
            ...
            label: nls.localize2(1382, "Copy Line Down"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '2_line',
                title: nls.localize(1377, "Co&&py Line Down"),
                order: 2
            },
            canTriggerInlineEdits: true,
        });
...
export class DuplicateSelectionAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1383, "Duplicate Selection"),
            precondition: EditorContextKeys.writable,
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '2_line',
                title: nls.localize(1378, "&&Duplicate Selection"),
                order: 5
            },
            canTriggerInlineEdits: true,
        });
...
class MoveLinesUpAction extends AbstractMoveLinesAction {
    constructor() {
        super(false, {
            ...
            label: nls.localize2(1384, "Move Line Up"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '2_line',
                title: nls.localize(1379, "Mo&&ve Line Up"),
                order: 3
            },
            canTriggerInlineEdits: true,
        });
...
class MoveLinesDownAction extends AbstractMoveLinesAction {
    constructor() {
        super(true, {
            ...
            label: nls.localize2(1385, "Move Line Down"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '2_line',
                title: nls.localize(1380, "Move &&Line Down"),
                order: 4
            },
            canTriggerInlineEdits: true,
        });
...
export class SortLinesAscendingAction extends AbstractSortLinesAction {
    constructor() {
        super(false, {
            ...
            label: nls.localize2(1386, "Sort Lines Ascending"),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true,
        });
    }
...
export class SortLinesDescendingAction extends AbstractSortLinesAction {
    constructor() {
        super(true, {
            ...
            label: nls.localize2(1387, "Sort Lines Descending"),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true,
        });
    }
...
export class DeleteDuplicateLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1388, "Delete Duplicate Lines"),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true,
        });
    }
...
export class ReverseLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1389, "Reverse lines"),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
...
export class TrimTrailingWhitespaceAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1390, "Trim Trailing Whitespace"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
export class DeleteLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1391, "Delete Line"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
...
export class IndentLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1392, "Indent Line"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class OutdentLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1393, "Outdent Line"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
export class InsertLineBeforeAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1394, "Insert Line Above"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
export class InsertLineAfterAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1395, "Insert Line Below"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
export class DeleteAllLeftAction extends AbstractDeleteAllToBoundaryAction {
    constructor() {
        super({
            id: 'deleteAllLeft',
            label: nls.localize2(1396, "Delete All Left"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.textInputFocus,
                primary: 0,
...
export class DeleteAllRightAction extends AbstractDeleteAllToBoundaryAction {
    constructor() {
        super({
            id: 'deleteAllRight',
            label: nls.localize2(1397, "Delete All Right"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.textInputFocus,
                primary: 0,
...
export class JoinLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1398, "Join Lines"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: 0,
...
export class TransposeAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1399, "Transpose Characters around the Cursor"),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true,
        });
    }
...
export class UpperCaseAction extends AbstractCaseAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1400, "Transform to Uppercase"),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true,
        });
    }
...
export class LowerCaseAction extends AbstractCaseAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1401, "Transform to Lowercase"),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
...
export class TitleCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1402, "Transform to Title Case"),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
...
export class SnakeCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1403, "Transform to Snake Case"),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true,
        });
    }
...
export class CamelCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1404, "Transform to Camel Case"),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
...
export class PascalCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1405, "Transform to Pascal Case"),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true,
        });
    }
...
export class KebabCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1406, 'Transform to Kebab Case'),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true,
        });
    }
