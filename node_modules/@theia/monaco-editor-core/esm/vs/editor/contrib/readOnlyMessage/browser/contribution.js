        ...
        if (messageController && this.editor.hasModel()) {
            ...
            if (!message) {
                if (this.editor.isSimpleWidget) {
                    message = new MarkdownString(nls.localize(1510, "Cannot edit in read-only input"));
                }
                else {
                    message = new MarkdownString(nls.localize(1511, "Cannot edit in read-only editor"));
                }
            }
