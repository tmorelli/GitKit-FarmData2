...
export class LinkedEditingAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1408, "Start Linked Editing"),
...
export const editorLinkedEditingBackground = registerColor('editor.linkedEditingBackground', { dark: Color.fromHex('#f00').transparent(0.3), light: Color.fromHex('#f00').transparent(0.3), hcDark: Color.fromHex('#f00').transparent(0.3), hcLight: Color.white }, nls.localize(1407, 'Background color when the editor auto renames on type.'));
