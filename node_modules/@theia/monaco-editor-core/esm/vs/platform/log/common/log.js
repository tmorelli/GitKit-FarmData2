...
export function LogLevelToLocalizedString(logLevel) {
    switch (logLevel) {
        case LogLevel.Trace: return { original: 'Trace', value: nls.localize(1888, "Trace") };
        case LogLevel.Debug: return { original: 'Debug', value: nls.localize(1889, "Debug") };
        case LogLevel.Info: return { original: 'Info', value: nls.localize(1890, "Info") };
        case LogLevel.Warning: return { original: 'Warning', value: nls.localize(1891, "Warning") };
        case LogLevel.Error: return { original: 'Error', value: nls.localize(1892, "Error") };
        case LogLevel.Off: return { original: 'Off', value: nls.localize(1893, "Off") };
    }
}
