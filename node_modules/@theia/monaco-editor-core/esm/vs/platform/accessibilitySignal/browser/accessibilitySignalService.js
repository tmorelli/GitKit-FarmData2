...
export class AccessibilitySignal {
    ...
    static { this.codeActionTriggered = AccessibilitySignal.register({
        name: localize(1755, 'Code Action Request Triggered'),
