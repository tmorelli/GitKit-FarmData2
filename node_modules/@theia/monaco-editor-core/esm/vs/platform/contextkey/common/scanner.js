...
function hintDidYouMean(...meant) {
    switch (meant.length) {
        case 1:
            return localize(1831, "Did you mean {0}?", meant[0]);
        case 2:
            return localize(1832, "Did you mean {0} or {1}?", meant[0], meant[1]);
        case 3:
            return localize(1833, "Did you mean {0}, {1} or {2}?", meant[0], meant[1], meant[2]);
        default: // we just don't expect that many
            return undefined;
    }
}
const hintDidYouForgetToOpenOrCloseQuote = localize(1834, "Did you forget to open or close the quote?");
const hintDidYouForgetToEscapeSlash = localize(1835, "Did you forget to escape the '/' (slash) character? Put two backslashes before it to escape, e.g., '\\\\/\'.");
/**
