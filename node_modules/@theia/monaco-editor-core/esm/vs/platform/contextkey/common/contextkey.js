...
const errorEmptyString = localize(1811, "Empty context key expression");
const hintEmptyString = localize(1812, "Did you forget to write an expression? You can also put 'false' or 'true' to always evaluate to false or true, respectively.");
const errorNoInAfterNot = localize(1813, "'in' after 'not'.");
const errorClosingParenthesis = localize(1814, "closing parenthesis ')'");
const errorUnexpectedToken = localize(1815, "Unexpected token");
const hintUnexpectedToken = localize(1816, "Did you forget to put && or || before the token?");
const errorUnexpectedEOF = localize(1817, "Unexpected end of expression");
const hintUnexpectedEOF = localize(1818, "Did you forget to put a context key?");
/**
...
export class Parser {
    ...
    _errExpectedButGot(expected, got, additionalInfo) {
        const message = localize(1819, "Expected: {0}\nReceived: '{1}'.", expected, Scanner.getLexeme(got));
        ...
        if (parser.lexingErrors.length > 0) {
            return parser.lexingErrors.map((se) => ({
                errorMessage: se.additionalInfo ?
                    localize(1820, "Unexpected token. Hint: {0}", se.additionalInfo) :
                    localize(1821, "Unexpected token."),
                offset: se.offset,
