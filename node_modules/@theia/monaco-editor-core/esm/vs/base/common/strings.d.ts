 ...
 */
export declare function replaceAsync(str: string, search: RegExp, replacer: (match: string, ...args: unknown[]) => Promise<string>): Promise<string>;
...
export declare class AmbiguousCharacters {
    ...
    static getInstance(locales: Iterable<string>): AmbiguousCharacters;
