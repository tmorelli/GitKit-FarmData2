import type { ColorDefinition, IJSONSchema, IJSONSchemaSnippet, JSONObject, PreferenceSchema, TaskDefinition } from './protocol-shims';
...
export interface NormalizeContributionsContext<TPlugin extends PluginManifest = PluginManifest> {
    ...
    transformIconUrl?(plugin: TPlugin, original?: IconUrl): {
        iconUrl?: IconUrl;
        themeIcon?: string;
    } | undefined;
...
export interface NormalizedPluginContribution {
    ...
    viewsContainers?: {
        [location: string]: NormalizedViewContainer[];
    };
    views?: {
        [location: string]: PluginPackageView[];
    };
...
//# sourceMappingURL=contribution-types.d.ts.map