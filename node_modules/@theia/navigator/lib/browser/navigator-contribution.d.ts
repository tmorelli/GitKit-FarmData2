...
import { CommandRegistry, MenuModelRegistry, MenuPath, MessageService, Mutable, PreferenceService, QuickInputService } from '@theia/core/lib/common';
...
export declare class FileNavigatorContribution extends AbstractViewContribution<FileNavigatorWidget> implements FrontendApplicationContribution, TabBarToolbarContribution {
     ...
     */
    protected pasteIntoNavigator(): Promise<void>;
